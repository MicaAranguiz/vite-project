...
export const App = (props) => {
  ...
  const handleSubmit2 = (event) => {
    event.preventDefault();
    axios.post('http://localhost:3000/api/posts',{descripcion,fecha,imagen,ubicacion,idUser})
    .then((resp)=>{
  ...
  return (
    ...
    <form action="" onSubmit={handleSubmit2}>
        ...
        <br />
        <br />
        <label htmlFor="">idUser: <input type="idUser" name="idUser" id="idUser" value={idUser} onChange={event => setidUser(event.target.value)} />
        </label>
        <br />
        <br />
        <button type='submit'>Enviar</button>
